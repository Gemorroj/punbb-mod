...
if (isset($_POST['form_sent'])) {
    ...
    if (!$errors && !isset($_POST['preview'])) {
        ...
        if (!$pun_user['is_guest'] && !$fid && (1 == ($is_admmod && $_POST['merge']) || !$is_admmod) && $cur_posting['poster_id'] && $cur_posting['message'] && $_SERVER['REQUEST_TIME'] - $cur_posting['posted'] < $pun_config['o_timeout_merge']) {
            // Preparing separator
