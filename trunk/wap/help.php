...
<div class="msg">&#187; <a href="'.dirname($_SERVER['PHP_SELF']).'/help.php?id=3">'.$lang_common['Smilies'].'</a></div>
<div class="msg2">&#187; <a href="'.dirname($_SERVER['PHP_SELF']).'/help.php?id=1">'.$lang_common['BBCode'].'</a></div>
<div class="msg">&#187; <a href="'.dirname($_SERVER['PHP_SELF']).'/help.php?id=2">'.$lang_help['Links and images'].'</a></div>';
...
echo '
<div class="inbox"><a href="index.php">'.$lang_common['Index'].'</a> &#187; <a href="help.php">'.$lang_help['Help'].'</a> &#187; '.$lang_common['BBCode'].'</div>
...
echo '
<div class="inbox"><a href="index.php">'.$lang_common['Index'].'</a> &#187; <a href="help.php">'.$lang_help['Help'].'</a> &#187; '.$lang_help['Links and images'].'</div>
...
echo '
<div class="inbox"><a href="index.php">'.$lang_common['Index'].'</a> &#187; <a href="help.php">'.$lang_help['Help'].'</a> &#187; '.$lang_common['Smilies'].'</div>';
...
if (!isset($smiley_text[$i])) {
    ...
    echo '
    <div class="' . $msg_class . '"><img src="' . PUN_ROOT . 'img/smilies/' . $cur_img . '" alt="' . $cur_text . '"/>
    <input type="text" value="' . $smiley_text[$i] . '" size="5" />';
...
require_once PUN_ROOT . 'wap/header.php';
echo '
<div class="inbox"><a href="index.php">'.$lang_common['Index'].'</a> &#187; <a href="help.php">'.$lang_help['Help'].'</a> &#187; '.$lang_common['img tag'].'</div>
