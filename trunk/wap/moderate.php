...
print '<div class="con"><a href="index.php">'.$lang_common['Index'].'</a> / <a href="viewforum.php?id='.$fid.'">'.pun_htmlspecialchars($cur_topic['forum_name']).'</a> / '.pun_htmlspecialchars($cur_topic['subject']).'<br/></div>
<div class="input">
<form method="post" action="moderate.php?fid='.$fid.'&amp;tid='.$tid.'">
<div>';
...
/*
if(fmod($start_from + $post_count,2))
{$class = 'msg';}
else
{$class = 'msg2';}
*/
...
print '<div><strong>';
if($action == 'single')
{print $lang_misc['Move topic'];}
else
{print $lang_misc['Move topics'];}
print '</strong><br/></div>
<div class="input">
...
print '</optgroup></select><br />
<input type="checkbox" name="with_redirect" value="1"';
if($action == 'single'){
echo ' checked="checked"';
}
print ' />'.$lang_misc['Leave redirect'].'<br />
</fieldset>
<br/>
...
print '<div><strong>'.$lang_misc['Delete topics'].'</strong><br/></div>
<div class="input">
<form method="post" action="moderate.php?fid='.$fid.'">
<div>
...
print '<div class="con"><a href="index.php">'.$lang_common['Index'].'</a> / '.pun_htmlspecialchars($cur_forum['forum_name']).'<br/></div>
...
if(trim($icon_text))
{$out.= '<div class="red">'.trim($icon_text).'<br/></div>';}
