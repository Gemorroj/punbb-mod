...
print '<div><strong>'.$lang_register['Forum rules'].'</strong></div>
<div class="input">
...
'req_image' => $lang_register['Image text'],
...
print '<div><strong>'.$lang_register['Register'].'</strong></div>
<div class="input">
...
print '<fieldset><legend>'.$lang_register['Pass legend 1'].'<br/></legend>
...
// IMAGE VERIFICATION MOD BEGIN
if($pun_config['o_regs_verify_image'] == 1){
print '<fieldset><legend>'.$lang_register['Image verification'].'<br/></legend>
...
<input type="text" name="req_image"/><br />
...
print '<strong>'.$lang_common['E-mail'].'</strong><br /><input type="text" name="req_email1" maxlength="50" /><br />';
if($pun_config['o_regs_verify'] == 1){
print '<strong>'.$lang_register['Confirm e-mail'].'</strong><br /><input type="text" name="req_email2" maxlength="50" /><br />';
}
...
print $lang_prof_reg['Language'].': '.$lang_prof_reg['Language info'].'<br/><select name="language">';
