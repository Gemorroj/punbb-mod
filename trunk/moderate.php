...
print '<div class="blockpost'.$vtbg.'">
...
print '</div><div class="clearer"></div></div></div></div>';

}

print '<div class="postlinksb">
<div class="inbox">
<p class="pagelink conl">'.$paging_links.'</p>
...
print '<div class="blockform"><h2><span>';
if($action == 'single'){
...
print ' />'.$lang_misc['Leave redirect'].'<br /></label>
</div>
</div>
</fieldset>
</div>
