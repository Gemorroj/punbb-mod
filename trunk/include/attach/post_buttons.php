...
<li><a style="font-size:10px" href="#" onclick="return insert_text('[size=10]', '[/size]');">10px</a></li>
<li><a style="font-size:12px" href="#" onclick="return insert_text('[size=12]', '[/size]');">12px</a></li>
<li><a style="font-size:14px" href="#" onclick="return insert_text('[size=14]', '[/size]');">14px</a></li>
<li><a style="font-size:16px" href="#" onclick="return insert_text('[size=16]', '[/size]');">16px</a></li>
<li><a style="font-size:18px" href="#" onclick="return insert_text('[size=18]', '[/size]');">18px</a></li>
<li><a style="font-size:20px" href="#" onclick="return insert_text('[size=20]', '[/size]');">20px</a></li>
</ul>
</li>
...
for ($i = 0, $a = sizeof($smiley_text); $i < $a; ++$i) {
    echo '<img src="' . PUN_ROOT . 'img/smilies/' . $smiley_img[$i] . '" alt="' . $smiley_text[$i] . '" style="cursor: pointer" onclick="return insert_text(\' ' . $smiley_text[$i] . ' \', \'\');"/> ';
}
?>
</div></div><br class="clearb"/>