...
echo \'<form id="qjump" method="get" action="viewforum.php"><div><label>' . $lang_common['Jump to'] . '<br /><select name="id" onchange="window.location=(\\\'' . $pun_config['o_base_url'] . ((basename(dirname($_SERVER['PHP_SELF'])) == 'wap') ? '/wap' : '') . '/viewforum.php?id=\\\'+this.options[this.selectedIndex].value)">';
