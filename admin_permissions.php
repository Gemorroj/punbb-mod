...
if (isset($_POST['form_sent'])) {
    ...
    foreach ($form as $key => $input) {
        ...
        if (\array_key_exists('p_'.$key, $pun_config) && $pun_config['p_'.$key] != $input) {
            $db->query('UPDATE '.$db->prefix.'config SET conf_value='.$input.' WHERE conf_name=\'p_'.$db->escape($key).'\'') || \error('Unable to update board config', __FILE__, __LINE__, $db->error());
        }
    }
...
?>
<div class="blockform">
    <h2><span><?php echo $lang_admin['Permissions']; ?></span></h2>

    <div class="box">
        <form method="post" action="admin_permissions.php">
            <p class="submittop"><input type="submit" name="save" value="<?php echo $lang_admin['Upd']; ?>"/></p>

            <div class="inform">
                <input type="hidden" name="form_sent" value="1"/>
                <fieldset>
                    <legend><?php echo $lang_admin['Num posts']; ?></legend>
                    <div class="infldset">
                        <table class="aligntop" cellspacing="0">
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions img']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions mess caps']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions theme caps']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions guest email']; ?></th>
                                <td>
            ...
            <div class="inform">
                <fieldset>
                    <legend><?php echo $lang_admin['Sig']; ?></legend>
                    <div class="infldset">
                        <table class="aligntop" cellspacing="0">
                            <tr>
                                <th scope="row">BBCode</th>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions sig caps']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions sig len']; ?></th>
                                <td>
                                    <input type="text" name="form[sig_length]" size="5" maxlength="5"
                                           value="<?php echo $pun_config['p_sig_length']; ?>"/>
                                    <span><?php echo $lang_admin['Permissions sig len about']; ?></span>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions sig lin']; ?></th>
                                <td>
                                    <input type="text" name="form[sig_lines]" size="3" maxlength="3"
                                           value="<?php echo $pun_config['p_sig_lines']; ?>"/>
                                    <span><?php echo $lang_admin['Permissions sig lin about']; ?></span>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="inform">
                <fieldset>
                    <legend><?php echo $lang_admin['Moderators']; ?></legend>
                    <div class="infldset">
                        <table class="aligntop" cellspacing="0">
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions mod edit']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions mod rename']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions mod repass']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions mod ban']; ?></th>
                                <td>
            ...
            <div class="inform">
                <fieldset>
                    <legend><?php echo $lang_admin['Reg']; ?></legend>
                    <div class="infldset">
                        <table class="aligntop" cellspacing="0">
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions email ban']; ?></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><?php echo $lang_admin['Permissions email double']; ?></th>
                                <td>
            ...
            <p class="submitend"><input type="submit" name="save" value="<?php echo $lang_admin['Upd']; ?>"/></p>
        </form>
    </div>
</div>
