...
<div class="block">
    ...
    <div class="box">
        <div class="inbox">
            <p>Этот плагин используется для очистки от лишних сообщений спаммеров и редактирует базу данных приводя в
...
<div class="block">
    ...
    <div class="box">
        <form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
            <div class="inbox">
                <p>Позволяет навести порядок после атаки спаммеров. Работает так: вы вводите один или несколько IP
