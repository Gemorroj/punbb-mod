...
<input type="checkbox" name="popup_enable" value="1"{if $user.popup_enable == 1} checked="checked"{/if} />{$lang_pms.$Use_popup}<br />
<input type="checkbox" name="messages_enable" value="1"{if $user.messages_enable == 1} checked="checked"{/if} />{$lang_pms.$Use_messages}
</div>
<div class="go_to">
