...
<strong> &#187; {$cur_topic.forum_name}</strong><br /> {$pun_config.o_base_url}/viewforum.php?id={$cur_topic.forum_id}<br />
...
<strong>{$cur_post.username|escape} &#187; {$cur_post.posted|date_format:$date_format}</strong></td></tr>
