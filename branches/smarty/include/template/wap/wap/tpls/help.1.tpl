...
<div class="inbox">
<a href="index.php">{$lang_common.Index}</a> &#187; <a href="help.php">{$lang_help.Help}</a> &#187; {$lang_common.BBCode}</div>
...
{$lang_help.$produces_quote_box}<br />
<div class="quote">{$lang_help.$Quote_text}</div></div>
...
<div class="code">{$lang_common.Code}:<div class="scrollbox" style="height:4.5em"><table class="p_cnt" style="font-family:Courier New;"><tr><td style="width:1pt;"><table><tr><td>1</td></tr></table></td><td><table><tr><td><span>{$lang_help.$Code_text}</span></td></tr></table></td></tr></table></div></div>
</div>
