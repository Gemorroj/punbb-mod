...
echo '<p class="conr"><strong><a href="/">' . pun_htmlspecialchars($pun_config['o_base_url']) . '</a></strong></p><p class="conr">PunBB Mod v' . pun_htmlspecialchars($pun_config['o_show_version']) . '<br />' . sprintf('%.3f', microtime(true) - $pun_start) . ' s</p><div class="clearer"></div></div></div></div>';
